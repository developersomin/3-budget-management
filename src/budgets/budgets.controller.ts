...
export class BudgetsController {
	...
	designBudget(@Body() designBudgetDto: DesignBudgetDto, @User('id') userId: string): Promise<BudgetCategory[]> {
		return this.budgetsService.designBudget(designBudgetDto, userId);
	}
}
